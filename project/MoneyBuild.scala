...
object MoneyBuild extends Build {
  ...
  .aggregate(moneyCore, moneyAspectj, moneyHttpClient, moneyJavaServlet, moneyKafka, moneySpring, moneyWire)
  ...
  object Dependencies {
    ...
    def akkaTestkit(scalaVersion: String) = "com.typesafe.akka" %% "akka-testkit" % akkaVersion % "it,test"
